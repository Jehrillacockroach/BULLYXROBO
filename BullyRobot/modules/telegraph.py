    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "m":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await h.edit("ᴜᴘʟᴏᴀᴅᴇᴅ ᴛᴏ https://telegra.ph{})".format(media_urls[0]), link_preview=True)
        elif input_str == "t":
            ...
            ms = (end - start).seconds
            await event.reply("ᴘᴀsᴛᴇᴅ ᴛᴏ https://telegra.ph/{} ɪɴ {} sᴇᴄᴏɴᴅs.".format(response["path"], ms), link_preview=True)
    else:
        await event.reply("ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴛᴏ ɢᴇᴛ ᴘᴇʀᴍᴀɴᴇɴᴛ ᴛᴇʟᴇɢʀᴀᴘʜ ʟɪɴᴋ")
