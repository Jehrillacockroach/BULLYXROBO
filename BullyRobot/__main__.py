...
PM_START_TEXT = """
*ʜᴇʏ,\n✪ ᴛʜɪs ɪs ʙᴜʟʟʏ ✘ ʀᴏʙᴏᴛ~🇮🇩* [!](https://telegra.ph/file/6077e4935bb20499768a8.jpg)\n*✪ ᴍᴏᴅᴜʟᴀʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ*\n────────────────────────\n➻ ᴜsᴇʀs » {}\n➻ ᴄʜᴀᴛs » {}\n➻ ᴜᴘᴛɪᴍᴇ » {}\n────────────────────────\n*✪ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʜᴇʟᴩ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴄᴏᴍᴍᴀɴᴅs.\n*​
"""

buttons = [
    [
        InlineKeyboardButton(
            text="✗ ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ​ ✗", url="https://t.me/bullyxguardianbot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            text="❄ ᴜᴘᴅᴀᴛᴇs ❄", url="https://t.me/bullyupdates"),
        InlineKeyboardButton(
...
BullyRobot_IMG = "https://telegra.ph/file/6077e4935bb20499768a8.jpg"                                
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                PM_START_TEXT.format(sql.num_users(), sql.num_chats(), uptime),
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                  [
                  InlineKeyboardButton(text=" Support ", url=f"https://t.me/BullyxSupport"),
                  InlineKeyboardButton(text=" Updates ", url="https://t.me/BullyxSupport"),
                  ]
                ]
            ),
        )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/bullyupdates"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="ᴅᴇᴠᴇʟᴏᴩᴇʀ", url="https://t.me/jehrilla_cockroach"
                        ),
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ", url="https://github.com/cyberxron"
                        ),
                    ],
                    [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(f"@{SUPPORT_CHAT}", "https://telegra.ph/file/6077e4935bb20499768a8.jpg", caption="ʙᴜʟʟʏ ✘ ʀᴏʙᴏᴛ ɪs ᴀʟɪᴠᴇ !\n\nᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ ʙᴜʟʟʏ 🥀")
        except Unauthorized:
            LOGGER.warning(
